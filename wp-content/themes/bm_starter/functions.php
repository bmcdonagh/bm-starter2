<?php
/**
 * bm_starter functions and definitions
 *
...
if ( ! function_exists( 'bm_starter_setup' ) ) :
	...
	function bm_starter_setup() {
		 ...
		 * If you're building a theme based on bm_starter, use a find and replace
		 * to change 'bm_starter' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'bm_starter', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'bm_starter' ),
		) );
...
function bm_starter_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'bm_starter' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'bm_starter' ),
...
function bm_starter_scripts() {
	...
	wp_enqueue_script( 'bm_starter-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
